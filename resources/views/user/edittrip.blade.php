...
<div id="page-wrapper">
    ...
    <article id="main">
        ...
        <div class="container">
            <div class="row">
                <form action="/user/updatetrip" method="post" class="form-horizontal">
                    {{csrf_field()}}
                    <fieldset>
                        <!-- Address form -->
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input id="first-name" value="{{$trip->destination}}" name="dest-name" type="text" placeholder="Destination"
                                       class="input-xlarge">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input id="last-name" value="{{$trip->location_name}}" name="dest-location" type="text" placeholder="location"
                                       class="input-xlarge">
                                <p class="help-block"></p>
                            </div>
                        </div>

                                <input value="{{$trip->id}}" name="trip_id" type="hidden" placeholder="location"
