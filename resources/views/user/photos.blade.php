                    ...
                    <div class="responsive">
                        <div class="gallery">
                            ...
                            <a target="_blank" href="{{$photo->photo_loc}}">
                                ...
                                <div class="desc"><b>Destination:</b>  {{$allphotos['trip']->destination}}</div>
                                <div class="desc"><b>Location:</b>  {{$allphotos['trip']->location_name}}</div>
{{--                                <div class="desc"><b>Email:</b>  {{$allphotos['user']->name}}</div>--}}
                                {{--<div class="desc"><b>Email:</b>  {{$allphotos['user']->email}}</div>--}}
                                <form action="/user/photo/submit" method="post">
                                    {{csrf_field()}}
                                    <input type="text" name="comment" class="form-group" placeholder="Your thoughts here!">
                                    <input type="hidden" name="photo_id" value="{{$photo->id}}" class="form-group" placeholder="Your thoughts here!">
                                    <input type="submit" value="Comment">
                                </form>
                                <button type="button" data-id="{{$photo->id}}" class="btn btn-primary comment">Show Comments</button>
                            @endforeach
                        </div>
                    </div>
                </div>
