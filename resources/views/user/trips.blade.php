...
<div id="page-wrapper">
    ...
    <article id="main">
        ...
        <div class="container">
                ...
                <table class="table">
                    ...
                    @foreach($alltrip as $trip)
                        <tr>
                            ...
                            <td><button type="button" data-id="{{$trip->id}}" class="btn btn-primary edit">Edit</button></td>
                        </tr>
                    @endforeach
                </table>
            </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <button type="button" onclick="window.location.href='/user/addtrip'">Add New Trip</button>
                </div>
            </div>
        </div>
...
<script>
    $('.edit').click(function () {
        var id = $(this).data('id');
        window.location.href = "/user/edit/trip?id="+id;
    });
</script>
