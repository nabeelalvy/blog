...
<div id="page-wrapper">
    ...
    <header id="header" class="alt">
        <h1 id="logo"><a href="/admin/index">Fotoğraf <span>by Alvy's</span></a></h1>
        <nav id="nav">
            <ul>
                <li class="current"><a href="/admin/index">Home</a></li>
                <li class="submenu">
                    <a href="#">Menu</a>
                    <ul>
                        ...
                        <li class="submenu">
                            <a href="#">Comments</a>
                            <ul>
                                <li><a href="/admin/allpcomments">Photos</a></li>
                                <li><a href="/admin/allvcomments">Videos</a></li>
                            </ul>
                        </li>
                        <li class="submenu">
    ...
    <section id="banner">
        ...
        <div class="inner">
            ...
            <p>
                save your <br /><strong>Memories</strong>
                <br />
                with us.</p>
            <footer>
                <ul class="buttons vertical">
                    <li><a href="login" class="button fit scrolly">Tell us your next trip</a></li>
                </ul>
            </footer>
        ...
        <section class="wrapper style3 container special">
            ...
            <div class="row">
                <div class="6u 12u(narrower)">
                    ...
                    <section>
                        <a href="#" class="image featured"><img src="{{URL::asset('images/pic01.jpg')}}" alt="" /></a>
                        <header>
                ...
                <div class="6u 12u(narrower)">
                    ...
                    <section>
                        <a href="#" class="image featured"><img src="{{URL::asset('images/pic02.jpg')}}" alt="" /></a>
                        <header>
            ...
            <div class="row">
                <div class="6u 12u(narrower)">
                    ...
                    <section>
                        <a href="#" class="image featured"><img src="{{URL::asset('images/pic03.jpg')}}" alt="" /></a>
                        <header>
                ...
                <div class="6u 12u(narrower)">
                    ...
                    <section>
                        <a href="#" class="image featured"><img src="{{URL::asset('images/pic04.jpg')}}" alt="" /></a>
                        <header>
