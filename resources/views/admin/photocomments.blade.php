...
<div id="page-wrapper">
    ...
    <!-- Header -->
    <header id="header">
        <h1 id="logo"><a href="/admin/index">Fotoğraf <span>by Alvy</span></a></h1>
        <nav id="nav">
            <ul>
                ...
                <table class="table">
                    ...
                    @foreach($allcomments as $comment)
                        <tr>
                            ...
                            <td><button class="delete" data-id="{{$comment->id}}">Delete Me</button></td>
                        </tr>
                    @endforeach
                </table>
            </div>
...
<script>
    $('.delete').click(function () {
        var id = $(this).data("id");
        window.location.href = "/admin/deletepcomment?id="+id;
    });
</script>
